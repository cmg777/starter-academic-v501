...
<div class="hero-native">
  <div class="hero-glass-card hero-glass-card--title hero-glass-card--delay-1">
    ...
    <p class="hero-subtitle" data-rotate="地理空間ビッグデータ|開発経済学|空間計量経済学|因果推論|機械学習" aria-label="地理空間ビッグデータ、開発経済学、空間計量経済学、因果推論、機械学習からの視点">地理空間ビッグデータ、開発経済学、空間計量経済学、因果推論、機械学習からの視点</p>
  </div>
