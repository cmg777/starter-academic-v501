...
<div class="hero-native">
  <div class="hero-glass-card hero-glass-card--title hero-glass-card--delay-1">
    ...
    <p class="hero-subtitle" data-rotate="Macrodatos geoespaciales|Economía del desarrollo|Econometría espacial|Inferencia causal|Aprendizaje automático" aria-label="Perspectivas desde los macrodatos geoespaciales, la economía del desarrollo, la econometría espacial, la inferencia causal y el aprendizaje automático">Perspectivas desde los macrodatos geoespaciales, la economía del desarrollo, la econometría espacial, la inferencia causal y el aprendizaje automático</p>
  </div>
