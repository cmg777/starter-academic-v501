...
/* Act I — production vs verification 2x2, with L-shaped axes (arrows + low/high) */
.reveal .tradeoff {
  display: grid;
...
# Working With AI: Three Tools, One Discipline {.divider background-color="#6a9bcc"}

[Act II]{.act}

## From "prompt engineering" to designing AI agent skills

A one-off clever prompt is fragile. A **skill** is reusable — and it can carry its own checks.

::: {.incremental}
- generates **consistent** outputs
- defines **sequential** tasks
- applies **verification** tests
:::

[Stop tuning prompts; start designing the agent's skills.]{.comment}

::: {.notes}
The mindset shift. Prompt engineering optimizes a single interaction; skill design encodes a repeatable procedure with checks built in. This is the discipline that makes the three tools trustworthy.
:::

## Great AI work starts with planning — and clarifying questions

Before it executes, make the AI **plan** and **ask**:

> *"Before you start, ask me questions until you are 95% confident you understand exactly what I need. Do not make any assumptions."*

::: {.incremental}
- activate **planning mode** first
- supply **reference materials** and examples
- build **verification** into the task
:::

::: {.notes}
This slide is self-referential — it is the exact instruction that produced this deck. Clarifying questions up front remove assumptions, which is where AI quality is won or lost.
:::
...
::: {.notes}
Tie back to Act I. Black-box research is unverifiable by construction; a version-controlled environment makes verification the default. And in the age of AI the barrier is low — your AI agent can teach you Git as you go.
:::
...
3. **Integrate the tools** — agentic skills with NotebookLM, Colab, and GitHub serve *both* production and verification.
:::
