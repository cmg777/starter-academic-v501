...
/* Act I — production vs verification 2x2 */
.reveal .tradeoff { max-width: 19em; margin: 0.2em auto 0; font-size: 0.74em; }
.reveal .tradeoff .axis-top,
.reveal .tradeoff .axis-bot { text-align: center; color: #6a6a68; text-transform: uppercase; letter-spacing: 0.09em; font-size: 0.78em; }
.reveal .tradeoff .axis-top { margin-bottom: 0.35em; }
.reveal .tradeoff .axis-bot { margin-top: 0.35em; }
...
<div class="tradeoff">
<div class="axis-top">↑ higher cost of verification</div>
<div class="grid">
...
<div class="axis-bot">low cost of production &nbsp;←&nbsp;·&nbsp;→&nbsp; high cost of production</div>
</div>
