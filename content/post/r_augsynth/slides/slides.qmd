...
::: {.notes}
Steelman, don't strawman. ASCM improves the counterfactual; it does not relax the identifying assumptions. Significance is genuinely borderline, and the gap mixes the tax cut with contemporaneous shocks a synthetic control cannot separate.
:::
