...
::: {.notes}
This is the defining problem of comparative case studies: a single treated unit, no natural control group. Donohue-Levitt-style difference-in-differences needs an untreated comparison; here there is none. The synthetic control method manufactures one. Set up the stakes: a real policy question with a one-of-a-kind treatment.
:::
...
::: {.column width="50%"}
### In-sample
- Weights estimated from a *finite* pre-window
- 31 years, 16 weights $\Rightarrow$ sampling noise
- Monte Carlo simulation
:::
::: {.column width="50%"}
### Out-of-sample
- Post-1990 shocks the model cannot foresee
- Structural breaks, surprises
