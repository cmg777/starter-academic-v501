...
[Every estimator in this deck is a different way to impute that missing $Y_{it}(0)$.]{.takeaway .fragment}
...
[Six dashed arrows feed one counterfactual box; the gap to the observed series is the effect.]{.takeaway .fragment}
...
[Estimand: purely *descriptive*. Identifying assumption: California's pre-level would have frozen — almost certainly false.]{.takeaway .fragment}
...
[Assumption: the pre-trend has the right *shape*. No comparison unit — so it can't separate policy from the secular decline.]{.takeaway .fragment}
...
[On 1988 sales, synthetic California (91.4) almost matches the real 90.1 — the donor average (114.2) is 24 packs off.]{.takeaway .fragment}
...
[Consensus cluster (RDD, SCM, CausalImpact): −13 to −20. Outliers: DiD collapses, ARIMA flips.]{.takeaway .fragment}
