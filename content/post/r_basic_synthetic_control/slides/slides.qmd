...
[The fundamental problem: $Y_{1t}^{N}$ is never observed. Synthetic control estimates it as a weighted average of donor regions.]{.comment}
...
[If the pre-1970 match is good, the post-1970 gap is the most plausible estimate of the conflict's cost.]{.comment}
...
[774 rows = 18 regions × 43 years. Pre-treatment window 1955–1969; post-treatment evaluation 1970–1997.]{.comment}
...
[Sparsity is typical: only a few donors resemble the treated unit, so the rest get weight zero.]{.comment}
...
[Basque $\approx$ 85% Catalonia + 15% Madrid — the only two comparably industrial, urban, wealthy regions.]{.comment}
...
[The synthetic nails outcome-relevant predictors; density shows the largest residual gap.]{.comment}
...
[Comparable to Basque's own ratio of 60.1 — one placebo run has limited inferential power.]{.comment}
