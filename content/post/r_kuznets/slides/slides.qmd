...
But the data to test it — regional accounts for poor *and* rich countries — barely exist. Lessmann (2013) assembled them. We rebuild the exercise on **synthetic** data so the whole pipeline is open.
...
::: {.notes}
Reference: Lessmann, C. (2013). Spatial inequality and development — Is there an inverted-U relationship? Journal of Public Economics 106, 35–51. Synthetic data; pedagogical replication.
:::
