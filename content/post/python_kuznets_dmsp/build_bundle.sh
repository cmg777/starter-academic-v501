#!/usr/bin/env bash
# Build content/post/python_kuznets_dmsp/python_kuznets_dmsp.zip from the
# tutorial sources. Re-run whenever tutorial.qmd, setup_env.py, _quarto.yml,
# script.py, the render wrappers, or the bundle README.md changes, then commit
# the regenerated zip.
