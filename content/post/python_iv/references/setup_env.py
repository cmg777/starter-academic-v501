...
into it, registers a named Jupyter kernel (`python_iv-tutorial`) that points at
...
# Direct imports (alphabetised) -> Intel-override transitive pins -> bootstrap.
# The Intel-override pair (numba 0.62.1 + llvmlite 0.45.0) is the last release
# that ships macOS Intel wheels; pyfixest pulls numba in transitively and
# without these pins macOS Intel users would face a slow source build.
PINNED: dict[str, str] = {
    "linearmodels": "7.0",
    "matplotlib":   "3.8.3",
    "numpy":        "1.26.4",
...
KERNEL_NAME = "python_iv-tutorial"
KERNEL_DISPLAY = "Python IV Tutorial"
