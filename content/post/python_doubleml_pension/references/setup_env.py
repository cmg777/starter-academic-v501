...
into it, registers a named Jupyter kernel (`python_doubleml_pension-tutorial`)
...
# Pinned versions probed from the dev machine. doubleml 0.11.2 requires
# numpy>=2.0, scikit-learn>=1.6, matplotlib>=3.9, pandas>=2.0, and
# statsmodels>=0.14, so the headline packages are pinned to a coherent
# modern stack. No macOS Intel wheel overrides are triggered: this script
# does not import pyfixest, statsmodels, sktime, or umap-learn directly.
PINNED: dict[str, str] = {
    "doubleml":     "0.11.2",
    "matplotlib":   "3.10.8",
    "numpy":        "2.1.3",
...
KERNEL_NAME = "python_doubleml_pension-tutorial"
KERNEL_DISPLAY = "Python DoubleML Pension Tutorial"
