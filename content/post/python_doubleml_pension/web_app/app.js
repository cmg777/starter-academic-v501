...
(function () {
  ...
  // ------------------------------------------------------------------
  // TAB 1 — L1/L2 animation (recycled to show "naive vs DML" intuition).
  // ------------------------------------------------------------------
  ...
  // ------------------------------------------------------------------
  // TAB 3 — PLR vs IRM vs IIVM.
  //   Reuse rigorous (PLR/IRM side) and CV (IIVM-like LATE) machinery
  //   from lasso.js. The asymmetry slider here represents how much controls
  //   predict d vs y — a stylised confounding-strength knob.
  // ------------------------------------------------------------------
  const sh = {
    n: 200, p: 40, signal: 0.5, asymmetry: 0.30, seed: 7,
  ...
  // ------------------------------------------------------------------
  // TAB 4 — Forest plot from real DML results.
  // ------------------------------------------------------------------
  const fp = {
