...
into it, registers a named Jupyter kernel (`python_did-tutorial`) that points at
...
KERNEL_NAME = "python_did_covariates_lalonde-tutorial"
KERNEL_DISPLAY = "Python LaLonde Covariates DiD Tutorial"
