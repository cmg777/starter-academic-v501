...
[State fixed effects absorbed by first-differencing; year effects partialled out (Frisch–Waugh–Lovell). $p/n \approx 0.49$ — the high-dimensional regime where Double LASSO is meant to help.]{.takeaway .fragment}
...
[$\hat\alpha$, rigorous Double LASSO (SE 0.051) · matches the paper's −0.104; selection counts match exactly]{.bignum-label}
