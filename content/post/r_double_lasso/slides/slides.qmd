...
format:
  revealjs:
    ...
    # KaTeX renders the LaTeX. NOTE: Quarto loads KaTeX from a CDN (pinned here);
    # reveal.js itself is bundled locally in slides_files/. Math needs network.
    html-math-method:
      method: katex
      url: "https://cdn.jsdelivr.net/npm/katex@0.16.21/dist"
