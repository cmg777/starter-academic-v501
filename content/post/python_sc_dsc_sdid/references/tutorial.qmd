...
SDID → MASC → ASCM — with **one `mlsynth` class per rung**, on quarterly log
...
Every rung puts the cost above the **2.4%** previously published for this
dataset.
...
- The referendum cost the UK **2.7–3.1% of GDP by end-2018** and **3.8–4.2% by
  end-2019** on every rung, against 2.4% previously published.
- `mlsynth` puts all six rungs behind one interface.
