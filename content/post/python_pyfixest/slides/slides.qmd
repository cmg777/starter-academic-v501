...
[Block one entire class of confounders — innate ability, firm culture, institutional quality — in a single step.]{.takeaway .fragment}
...
[Subtract each group's own average, then run plain OLS — that is all a fixed effect does.]{.takeaway .fragment}
...
[The estimate never moves; only honesty about uncertainty does.]{.takeaway .fragment}
...
[One worker intercept each: the union premium halves and $R^2$ more than triples.]{.takeaway .fragment}
...
[union premium under one-way worker FE (was 18.3% in pooled OLS; one-way FE SE 0.024)]{.bignum-label}
...
[Time-varying $\hat\beta$ still match one-way FE; the time-invariant $\gamma$ become estimable again.]{.takeaway .fragment}
