...
**Easiest (one click).** From the [tutorial bundle](https://carlos-mendez.org/uploads/python_pyfixest_tutorial.zip), double-click `render.command` (macOS) or `render.bat` (Windows). The wrapper runs setup and then `quarto render`, opening the result in your browser.
