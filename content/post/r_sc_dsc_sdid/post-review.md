...
- **The traps are taught, not hidden.** Three places where a reader would predictably go wrong —
  the two conflicting definitions of $T\_0$, the two different meanings of "demeaned" between rungs
