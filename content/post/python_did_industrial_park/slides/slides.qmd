...
An industrial park is serviced land, power, and a one-stop customs office, rented to garment and leather factories. Ethiopia opened **20+ parks across 18 districts, 2008–2021**.
...
[A note on the data.]{.objection} Everything runs on **synthetic, calibrated** data — tuned to reproduce Huang, Wang & Xu (2026)'s signs, stars, and approximate magnitudes. Learn the *methods*, not new facts about Ethiopia.
