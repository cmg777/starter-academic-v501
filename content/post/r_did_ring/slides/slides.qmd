...
[The two are *algebraically* identical — that is why the ring DiD is one line of `feols()`.]{.takeaway .fragment}
...
[`delta_y` is the first-differenced outcome; `treat_ring` is the 0/1 inner-ring indicator. The whole estimator is that one regression.]{.takeaway .fragment}
