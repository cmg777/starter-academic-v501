...
| Stock-Yogo 10% max IV size | 16.32 | 16.38 (iid) |
...
[Response.]{.rebuttal} Add health controls and the effect dips to 0.55–0.69. But there the first-stage F falls to 1.2–4.9 (weak IV), and Hansen J fails to reject ($p = 0.46$–$0.80$). The doubt is real; it is the place to keep an open mind.
