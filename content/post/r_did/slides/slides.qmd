...
[Staggered adoption: there is no single "before" and "after" for the country — each state has its own clock.]{.takeaway .fragment}
...
[The estimand is the ATT — the effect on the counties that actually raised their wage.]{.takeaway .fragment}
...
[Like grading a student's improvement against classmates who already took the test — the "control" already saw the answer key.]{.takeaway .fragment}
...
[Callaway–Sant'Anna (2021): separate identification from estimation. Build the grid of $\mathrm{ATT}(g,t)$ first, average it later.]{.takeaway .fragment}
...
[TWFE *understated* the negative effect by about a third — attenuated toward zero.]{.takeaway .fragment}
...
[Three independent modeling routes agree — no model-dependence artifact.]{.takeaway .fragment}
