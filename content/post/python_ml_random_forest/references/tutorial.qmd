...
subtitle: "Predicting municipal development in Bolivia using Random Forest regression on satellite image embeddings"
...
**4. Train/test split** $D = D_{\mathrm{train}} \cup D_{\mathrm{test}}$.
...
**8. Partial dependence plot** $\bar f(x_k) = E_{X_{-k}}[\hat f(x_k, X_{-k})]$.
