...
into it, registers a named Jupyter kernel (`python_ml_random_forest-tutorial`) that points at
...
KERNEL_NAME = "python_ml_random_forest-tutorial"
KERNEL_DISPLAY = "Python Random Forest Tutorial"
