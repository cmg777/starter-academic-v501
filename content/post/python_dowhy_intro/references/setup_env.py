...
into it, registers a named Jupyter kernel (`<KERNEL_NAME>`) that points at
...
PINNED: dict[str, str] = {
    ...
    "statsmodels":  "0.14.1",
    # Last numba + llvmlite releases that ship macOS Intel wheels. dowhy
    # 0.14 requires numba>=0.59, so this satisfies its constraint while
...
KERNEL_NAME = "python_dowhy_intro-tutorial"
KERNEL_DISPLAY = "Python DoWhy Intro Tutorial"
