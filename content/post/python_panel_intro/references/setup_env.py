...
into it, registers a named Jupyter kernel (`python_panel_intro-tutorial`) that points at
...
PINNED: dict[str, str] = {
    # Direct imports from script.py (probed from the dev machine).
    "linearmodels": "7.0",
    "matplotlib":   "3.10.8",
    "numpy":        "2.1.3",
    "pandas":       "2.3.3",
    ...
    "scipy":        "1.15.2",
    "statsmodels":  "0.14.6",
    # Last numba+llvmlite releases that ship macOS Intel wheels.
    # Triggered by pyfixest and statsmodels (Intel-override; see
    # write-quarto-notebook-python/references/intel-wheel-catalog.md).
    "llvmlite":     "0.45.0",
    "numba":        "0.62.1",
    # Bootstrap: jupyter + ipykernel needed for kernel registration.
    "jupyter":      "1.1.1",
    "ipykernel":    "6.29.5",
}

KERNEL_NAME = "python_panel_intro-tutorial"
KERNEL_DISPLAY = "Python Panel Intro Tutorial"
