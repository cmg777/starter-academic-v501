...
::: {.notes}
Steelman, don't strawman. Fixed effects discipline the comparison; they do not relax identification. The within estimand is local — it is identified off the ~9% of workers who switched status — and rests on strict exogeneity conditional on α_i. Reporting both the within and cross-sectional estimands, as the post does, is the honest move.
:::
