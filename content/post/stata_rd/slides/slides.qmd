...
[Students just below and just above 70 are comparable by construction — only treatment differs.]{.takeaway .fragment}
...
[The entrance distribution is right-skewed — most students cleared 70, so only about a quarter received tutoring.]{.takeaway .fragment}
...
[Identification rests on **continuity**: absent tutoring, outcomes pass *smoothly* through 70.]{.takeaway .fragment}
...
[Zero crossovers in either direction — treatment is a deterministic function of the score. This is a *sharp* RDD, the strongest form.]{.takeaway .fragment}
...
[The interaction term is essentially zero (−0.001), and R² is flat across all three — added flexibility buys nothing.]{.takeaway .fragment}
...
[Smaller bandwidth → less bias (more comparable units) but more variance (fewer observations). `rdrobust` picks the MSE-optimal $h$ automatically.]{.takeaway .fragment}
...
[Opposite signs, identical message: tutoring raises exit scores by roughly 9–11 points at the cutoff.]{.takeaway .fragment}
...
[Less than one point across a 4× change in window — not a bandwidth artifact.]{.takeaway .fragment}
...
[9–11 points is ~13–16% of the mean exit score (66.2) — passing vs failing for a borderline student.]{.takeaway .fragment}
