...
[An *unbalanced* panel: 1,663 country-years, T ranging from 1 to 13 — exactly what Arellano–Bond was designed for.]{.takeaway .fragment}
...
[`DemocIndxLag` loses 86.5% of its rows to recoding — which is why the published study drops it entirely.]{.takeaway .fragment}
...
[The lag is what makes the model "dynamic" — and what makes it hard to estimate.]{.takeaway .fragment}
...
[Belt and suspenders: differencing removes confounders, lag-instruments handle the lagged-DV endogeneity.]{.takeaway .fragment}
...
[We use lags $2$–$6$: deep enough to be exogenous, shallow enough to contain instrument proliferation.]{.takeaway .fragment}
...
[N = 1,187 country-years · 155 countries · 146 instruments · AR(2) $p = 0.091$ · Hansen $p = 0.184$.]{.takeaway .fragment}
...
[Economic freedom predicts growth ($t$ up to 3.31); political freedom never crosses $t = 1$.]{.takeaway .fragment}
...
[−0.35 → −0.17 is a 53% reduction: war damages institutions, and damaged institutions hurt growth.]{.takeaway .fragment}
