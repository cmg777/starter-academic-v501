...
[Omitting $\ln y_{i,t-1}$ assumes $\alpha = 0$ — instantaneous convergence, which the data flatly rejects.]{.takeaway .fragment}
...
[Marginal likelihood scores each of 512 "recipes" — rewarding fit, penalizing needless complexity.]{.takeaway .fragment}
...
[Drop one variable and the significance pattern changes — this fragility is what BMA is built to fix.]{.takeaway .fragment}
...
[That persistence absorbs the cross-sectional variation, leaving fewer variables with independent power.]{.takeaway .fragment}
...
[Robust = PIP above 0.5 even under the skeptical prior. Only two determinants qualify.]{.takeaway .fragment}
