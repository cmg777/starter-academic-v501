...
//
// Generated by /project:write-app from app.js.tmpl for python_doubleml.
...
(function () {
  ...
  // ------------------------------------------------------------------
  // TAB 3 — DML vs OLS Simulator.
  //   Uses LASSO.double_lasso under the hood — the rigorous-vs-CV
  //   comparison stands in for the post's RF-vs-LASSO learner swap.
  // ------------------------------------------------------------------
  const sh = {
  ...
  // ------------------------------------------------------------------
  // TAB 4 — Forest plot from results.json (post's 4 estimates).
  // ------------------------------------------------------------------
  const fp = {
