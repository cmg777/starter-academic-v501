...
[Different machinery, same target — agreement across them is what earns credibility.]{.takeaway .fragment}
...
[The marginal likelihood $P(y\mid M_k)$ is a built-in Occam's razor — complex models spread their probability thin.]{.takeaway .fragment}
...
[LASSO selects; OLS on the selected set estimates — recovering unbiased magnitudes.]{.takeaway .fragment}
...
[All five noise variables: flagged by none. Agreement across mechanically distinct methods is what earns credibility.]{.takeaway .fragment}
...
[Zero false positives across the board; the gap is in catching the moderate true effects.]{.takeaway .fragment}
