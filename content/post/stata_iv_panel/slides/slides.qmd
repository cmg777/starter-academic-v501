...
[The instrumental-variables strategy attacks all three at once — if we can find an exogenous source of variation in economic activity.]{.takeaway .fragment}
...
[Region effects, region trends, and year effects are pre-absorbed. SEs clustered on 5,689 regions.]{.takeaway .fragment}
...
[$\alpha_i$ are region fixed effects, $\beta_i t$ region-specific trends, $\gamma_t$ year effects. The parameter $\delta$ is the causal effect of economic activity on conflict probability.]{.takeaway .fragment}
...
[The estimate barely moves across instruments — strong evidence the causal finding is robust, not an artifact of one weather variable.]{.takeaway .fragment}
...
[Both instruments clear Stock–Yogo by a wide margin; the overid test says they tell the same story.]{.takeaway .fragment}
