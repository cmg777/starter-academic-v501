...
[A built-in `true_effect` column gives every estimate a known target to hit.]{.comment}
...
[TWFE fits one pooled $\delta$ — a weighted average of many 2×2 comparisons, some of them poisoned.]{.comment}
