...
::: {.notes}
This is the central tension of observational causal inference. The 275 g gap mixes the effect of smoking with the effect of every characteristic that differs between smokers and non-smokers. The whole tutorial is about subtracting that second piece — the selection bias — and seeing what is left.
:::
