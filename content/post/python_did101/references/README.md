...
- **Kernel not found:** if Render reports `Jupyter kernel 'python_did101-tutorial' not found`, you skipped the manual step — run `python3 setup_env.py` in a terminal and try again. The one-click wrapper avoids this entirely.
