...
into it, registers a named Jupyter kernel (`python_did101-tutorial`) that points at
...
KERNEL_NAME = "python_did101-tutorial"
KERNEL_DISPLAY = "Python DiD 101 Tutorial"
