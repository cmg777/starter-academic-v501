...
[The comparison group's +10.88 is the secular trend — the rise that would have happened anyway.]{.takeaway .fragment}
...
[Subtract the trend the control group reveals; what's left is the program's causal effect.]{.takeaway .fragment}
...
[The estimand is the ATT: the average effect for the schools that actually got the program.]{.takeaway .fragment}
...
[$\gamma_i$ wipes school stains, $\vartheta_t$ wipes period glare. PyFixest's `|` pipe absorbs both — no dummy bookkeeping.]{.takeaway .fragment}
...
[Three near-zero leads validate parallel trends; four large lags trace a stable effect.]{.takeaway .fragment}
