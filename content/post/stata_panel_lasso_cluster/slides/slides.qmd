...
[C-LASSO sits in the middle: $K$ latent groups, slopes shared *within* a group, free *across* groups.]{.takeaway .fragment}
...
[The product penalty $\prod_k\|\boldsymbol{\beta}_i-\boldsymbol{\alpha}_k\|$ vanishes when $\boldsymbol{\beta}_i$ is near *any* center $\boldsymbol{\alpha}_k$ — that's what sorts unit $i$ into a group.]{.takeaway .fragment}
...
[The textbook read: "inflation and interest rates don't affect savings." Hold that thought.]{.takeaway .fragment}
...
[All four highlighted CPI/interest coefficients are significant at $p < 0.001$. The pooled +0.030 was $-0.181$ and $+0.478$ canceling.]{.takeaway .fragment}
...
[Standard errors clustered on 98 countries. This replicates Acemoglu et al. (2019): on average, democracy promotes growth.]{.takeaway .fragment}
...
[This is Simpson's paradox in a panel: the aggregate trend reverses inside the subgroups.]{.takeaway .fragment}
