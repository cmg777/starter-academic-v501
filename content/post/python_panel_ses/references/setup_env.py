...
into it, registers a named Jupyter kernel (`python_panel_ses-tutorial`) that points at
...
KERNEL_NAME = "python_panel_ses-tutorial"
KERNEL_DISPLAY = "Python Panel SEs Tutorial"
