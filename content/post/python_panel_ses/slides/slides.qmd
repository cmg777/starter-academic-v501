...
[Because ability drives both $x$ and $y$, pooled OLS is *biased by design* — and AR(1) errors make SE choice critical.]{.comment}
...
[The estimate is *wrong*, and the tiny SE makes us wrongly confident in the wrong number.]{.comment}
...
[White SE = 0.0361 vs conventional 0.0345 — the $t$ slips only from 29.9 to 28.6.]{.comment}
...
[Ten observations from one firm carry far less than ten independent observations' worth of information.]{.comment}
...
[Cluster on the dimension with $\ge 40$–$50$ groups. Here that is firms (100), not years (10).]{.comment}
...
[Smallest SE in the deck — because firms are independent given their fixed effects *in this DGP*.]{.comment}
...
## Time clustering over-rejects at 9.0% — false positives almost twice as often
...
## Does machine-correcting the SE make the estimate causal? No
