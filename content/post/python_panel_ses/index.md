...
- icon: book
  ...
  url: https://github.com/cmg777/starter-academic-v501/blob/master/content/post/python_panel_ses/notebook.ipynb
- icon: markdown
  icon_pack: fab
  name: "MD version"
