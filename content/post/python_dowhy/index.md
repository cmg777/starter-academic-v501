...
- icon: book
  ...
  url: https://github.com/cmg777/starter-academic-v501/blob/master/content/post/python_dowhy/notebook.ipynb
- icon: r-project
  icon_pack: fab
  name: "R script"
  url: analysis.R
