...
into it, registers a named Jupyter kernel (`python_dowhy-tutorial`) that points at
...
PINNED: dict[str, str] = {
    ...
    # Last numba+llvmlite releases that ship macOS Intel wheels. dowhy pulls
    # numba in transitively; this satisfies that constraint while avoiding
...
KERNEL_NAME = "python_dowhy-tutorial"
KERNEL_DISPLAY = "Python DoWhy Tutorial"
