...
subtitle: "Estimating the causal effect of a job training program on earnings using DoWhy's four-step framework"
author: "Carlos Mendez"
date: "2026-03-12"
jupyter: python_dowhy-tutorial
format:
  html:
    theme: cosmo
...
#| fig-cap: "Distribution of 1978 earnings by treatment group. The training group shows a higher mean."
...
```{python}
#| label: fig-balance-categorical
#| fig-cap: "Proportions of categorical covariates for control and training groups. Both groups show similar demographic composition."
...
```{python}
#| label: fig-balance-smd
#| fig-cap: "Love plot showing standardized mean differences for all eight covariates. Most fall below the 0.1 threshold, indicating good balance."
...
#| fig-cap: "Causal graph generated by DoWhy showing confounders as common causes of both treatment and outcome."

# Visualize the causal graph using DoWhy's built-in method. This requires
# the system `graphviz` binary; if it is unavailable, we skip gracefully.
try:
...
#| fig-cap: "Comparison of ATE estimates across six methods."
...
- Companion script: [`script.py`](https://raw.githubusercontent.com/cmg777/starter-academic-v501/master/content/post/python_dowhy/script.py)
- Published post: <https://carlos-mendez.org/post/python_dowhy/>
