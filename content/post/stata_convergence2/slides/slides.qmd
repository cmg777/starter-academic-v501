...
[Unbalanced panel — 109 countries in 1960, 160 by 1990. Penn World Table 10.0 plus the Kremer et al. replication covariates. The analysis is **descriptive**: cross-country association, not a causal ATE.]{.takeaway .fragment}
...
[This is an exact algebraic identity, not an approximation — when the gap closes, at least one of $\delta$ or $\lambda$ must have shrunk.]{.takeaway .fragment}
...
[$\delta$ roughly halved, but $\lambda$ fell $\sim5\times$ — democracy went from a strong growth predictor to nearly none. The gap closed 91%.]{.takeaway .fragment}
