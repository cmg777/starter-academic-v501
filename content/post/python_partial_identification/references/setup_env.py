...
into it, registers a named Jupyter kernel (`python_partial_identification-tutorial`) that points at
...
KERNEL_NAME = "python_partial_identification-tutorial"
KERNEL_DISPLAY = "Python Partial Identification Tutorial"
