...
[Credible uncertainty over incredible certainty.]{.takeaway .fragment}
...
[The backdoor criterion needs $U$; since $U$ is unmeasured, every point estimate is biased by an unknown amount.]{.takeaway .fragment}
...
![Observed job rates: 25.4% untrained vs 63.6% trained — a raw 38.2-point gap that mixes effect and selection.](../partial_id_observed_probs.png)
...
[No parametric model, no exclusion restriction — only "the unseen counterfactual is a probability."]{.takeaway .fragment}
...
[`CausalBoundingEngine` matches the hand computation exactly — and in under a millisecond.]{.takeaway .fragment}
...
[Autobound solves an optimization and lands on the *same* interval — the worst-case distributions are genuinely valid.]{.takeaway .fragment}
...
[Entropy is a middle ground: more than "nothing" (Manski), less than "no confounders" (DoubleML).]{.takeaway .fragment}
...
[Tian–Pearl bounds: PNS $\in [0.000,\ 0.702]$.]{.takeaway .fragment}
...
[The identified set narrows only when you bring new information to bear.]{.takeaway .fragment}
