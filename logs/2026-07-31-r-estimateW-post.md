...
- **AI slides (PDF):** `AI-slides-Bayesian_Spatial_Weight_Estimation.pdf` (2.9 MB, user-supplied),
...
- **Featured image** `featured.webp` — supplied by the user (2752 x 1536). Never generated by the
  pipeline. `image.placement: 3` renders it full-width above the title.
